...
<form action="/save/{{$patients->enccode1}}" type="get" class="was-validated">
    ...
    <div class="container-xl" id="mainContainer">
        ...
        <div class="card-body border border-secondary">
                        ...
                        <div class="row">
                            ...
                            <div class="col border-start border-secondary divpat p-2">
                                <div class="row">
                                    <div class="col ">
                                        <b>Registry No:</b>
                                        <input type="text" class="inputlabelunderlineName" name="reg_no"
                                            value="{{$patients->reg_no}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <b>Philhealth No:</b>
                                        <input type="text" class="inputlabelunderlineName" name="pat_phil_health_no"
                                            value="{{$patients->pat_phil_health_no}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" readonly class="inputlabelunderline"
                                                    value="{{$patients->pat_current_address_region_name}}"
                                                    id="pat_current_address">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" readonly class="inputlabelunderline"
                                                    value="{{$patients->pat_current_address_province_name}}"
                                                    id="pat_current_province">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" readonly class="inputlabelunderline"
                                                    value="{{$patients->pat_current_address_city_name}}"
                                                    id="pat_current_city">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" readonly class="inputlabelunderline"
                                                    value="{{$patients->pat_current_address_brgy_name}}"
                                                    id="pat_current_bgy">
                                            </div>
                                        </div>
                                    </div>
            ...
            <input type="checkbox" id="copyCh" name="copyCh" value="1" {{ ($chdata->copyCh == '1'? ' checked' : '') }}> -->
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select id="temp_regcode" name="temp_regcode"
                                                    class="form-select-sm regioncategory inputlabelunderlineName"
                                                    aria-label=".form-select-sm example">
                                                    <option value="{{$patients->temp_regcode}}">
                                                        {{$patients->temp_regname}}</option>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select id="temp_provcode" name="temp_provcode"
                                                    class="form-select-sm regioncategory inputlabelunderlineName"
                                                    aria-label=".form-select-sm example">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select id="temp_citycode" name="temp_citycode"
                                                    class="form-select-sm regioncategory inputlabelunderlineName"
                                                    aria-label=".form-select-sm example">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select id="temp_bgycode" name="temp_bgycode"
                                                    class="form-select-sm regioncategory inputlabelunderlineName"
                                                    aria-label=".form-select-sm example">
                            ...
                            <div class="col border-top border-secondary" id="divaddress">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select id="plc_regcode" required name="plc_regcode"
                                                    class="form-select w-75 inputlabelunderlineName"
                                                    aria-label=".form-select-sm example">
                                                    <option value="{{$patients->plc_regcode}}">
                                                        {{$patients->plc_regname}}</option>
                                                    <option value="" id="">---</option>
                                                    @foreach($vwRegname as $item)
                                                    <option value="{{$item->regcode}}">{{$item->regname}}</option>
                                                    @endforeach
                                    ...
                                    <div class="col ">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select id="plc_provcode" required name="plc_provcode"
                                                    class="form-select inputlabelunderlineName"
                                                    aria-label=".form-select-sm example">
                                                    <option value="{{$patients->plc_provcode}}">
                                                        {{$patients->plc_provname}}</option>
                                                    <option value="">---</option>
                                                </select>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select id="plc_ctycode" required name="plc_ctycode"
                                                    class="form-select inputlabelunderlineName"
                                                    aria-label=".form-select-sm example">
                                                    <option value="{{$patients->plc_ctycode}}">
                                                        {{$patients->plc_ctyname}}</option>
                                                    <option value="">---</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select id="plc_bgycode" name="plc_bgycode"
                                                    class="form-select inputlabelunderlineName "
                                                    aria-label=".form-select-sm example">
                                                    <option value="{{$patients->plc_bgycode}}">
                                                        {{$patients->plc_bgyname}}</option>
                                                    <option value="">---</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <input type="text" class="inputlabelunderlineName" id="date_of_birth"
                                                    name="date_of_birth" readonly
                                                    value="{{date('d/m/Y',  strtotime($patients->pat_date_of_birth))}}">
                                            </div>
                                        </div>
                            ...
                            <div class="col border-top border-secondary" id="divbday">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" readonly class="inputlabelunderlineName" id="appt"
                                                    name="inj_date"
                                                    value="{{date('d/m/Y',  strtotime($patients->inj_date))}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" readonly class="inputlabelunderlineName"
                                                    name="encounter_date" id="encounter_date"
                                                    value="{{date('d/m/Y',  strtotime($patients->encounter_date))}}">
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            <div class="col">
                                                <b>Date report </b>
                                                <small><i style="color:red;"><svg xmlns="http://www.w3.org/2000/svg"
                                                            class="d-print-none" id="reqIcon" width="16" height="16"
                                                ...
                                                <input type="date" class="inputlabelunderlineName" required id="appt"
                                                    name="date_report" value="{{$patients->date_report}}">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="time" class="inputlabelunderlineName" readonly id="appt"
                                                    name="inj_time" required max="18:00"
                                                    value="{{date('H:i:s',  strtotime($patients->inj_time))}}">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="time" class="inputlabelunderlineName" readonly id="appt"
                                                    name="encounter_time" required max="18:00"
                                                    value="{{date('H:i:s',  strtotime($patients->encounter_time))}}">
                                    ...
                                    <div class="col">
                                        <b>Time report </b>
                                        <small><i style="color:red;"><svg xmlns="http://www.w3.org/2000/svg"
                                                    class="d-print-none" width="16" height="16" fill="currentColor"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="time" class="inputlabelunderlineName" id="appt"
                                                    name="time_report" required max="18:00"
                                                    value="{{date('H:i:s',  strtotime($patients->time_report))}}">
                                                <div class="invalid-feedback"><svg xmlns="http://www.w3.org/2000/svg"
                   ...
                   <select id="Pat_Facility_Prov" name="Pat_Facility_Prov" class="form-select-sm" aria-label=".form-select-sm example">
                        ...
                        <option value="">---</option>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" class="inputlabelunderlineName" readonly class=""
                                                    name="pat_facility_no" value="DOH000000000008577">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="col">
                        ...
                        <div class="row border-top border-secondary p-1">
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input type="text" class="inputlabelunderlineName" name="hosp_reg_no"
                                            value="{{$patients->hosp_reg_no}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input type="text" class="inputlabelunderlineName" name="hosp_cas_no"
                                            value="{{$patients->hosp_cas_no}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inj_intent_code"
                                        id="Unintentional/Accidental" value="01"
                                        {{ ($chdata->inj_intent_code == 'Unintentional/Accidental'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Unintentional/Accidental"
                                        id="divpat1">Unintentional/Accidental</label>
                                    <!-- <div class="row">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inj_intent_code"
                                        id="IntentionalV" value="02"
                                        {{ ($chdata->inj_intent_code == '02'? ' checked' : '') }}>
                                    <label class="form-check-label" for="IntentionalV">Intentional (violence)</label>

                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inj_intent_code" id="VAWC"
                                        value="04" {{ ($chdata->inj_intent_code == '04'? ' checked' : '') }}>
                                    <label class="form-check-label" for="VAWC"> VAWC Patient</label>

                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inj_intent_code"
                                        id="IntentionalS" value="03"
                                        {{ ($chdata->inj_intent_code == '03'? ' checked' : '') }}>
                                    <label class="form-check-label" for="IntentionalS">Intentional(self-inflict)</label>

                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inj_intent_code"
                                        id="Undetermined" value="99"
                                        {{ ($chdata->inj_intent_code == '99'? ' checked' : '') }}>
                        ...
                        <div class="col ">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="radio" name="rdoAid" id="aidYes" value="Y"
                                        {{ ($chdata->rdoAid == 'Y'? ' checked' : '') }}>
                                    <label class="form-check-label" for="aidYes">
                                        Yes</label>
                                </div>
                                <div class="col-auto">
                                    </label>
                                    <input class="form-check-input" type="radio" name="rdoAid" id="aidNo" value="N"
                                        {{ ($chdata->rdoAid == 'N'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="radio" name="rdoAid" id="aidUnk" value="U"
                                        {{ ($chdata->rdoAid == 'U'? ' checked' : '') }}>
                ...
                <div class="innerdiv">
                    <div class="row">
                        <div class="grid-containter" id="gridInjuries">
                            ...
                            <div class="item2">
                                <input class="form-check-input" required type="radio" name="injryRdo" id="injuryRdo1"
                                    value="Y" {{ ($chdata->injryRdo == 'Y'? ' checked' : '') }}>
                                <label class="form-check-label" for="injuryRdo1">
                                    Yes
                                </label>
                            </div>
                            <div class="item3">
                                <input class="form-check-input" type="radio" name="injryRdo" id="injuryRdo2" value="N"
                                    {{ ($chdata->injryRdo == 'N'? ' checked' : '') }}>
                        ...
                        <div class="container divpat1">
                            ...
                            <div class="row">
                                <div class="col col-lg-16">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="burnCh" id="burnCh" value="Y"
                                        {{ ($chdata->burnCh == 'Y'? ' checked' : '') }}>
                                    ...
                                    <input class="" type="checkbox" name="degree_burn1" id="degree_burn1"
                                        value="1st degree"
                                        {{ ($chdata->degree_burn1 == '1st degree'? ' checked' : '') }}>
                                    <label class="form-check-label" for="degree_burn1">
                                        1<sup>st</sup>

                                        <input type="hidden" name="degree_burn2" value="--">
                                        <input class="" type="checkbox" name="degree_burn2" id="degree_burn2"
                                            value="2nd degree"
                                            {{ ($chdata->degree_burn2 == '2nd degree'? ' checked' : '') }}>
                                        <label class="form-check-label" for="degree_burn2">
                                            2<sup>nd</sup>
                                        </label>

                                        <input type="hidden" name="degree_burn3" value="--">
                                        <input class="" type="checkbox" name="degree_burn3" id="degree_burn3"
                                            value="3rd degree"
                                            {{ ($chdata->degree_burn3 == '3rd degree'? ' checked' : '') }}>
                                        <label class="form-check-label" for="degree_burn3">
                                            3<sup>rd</sup>
                                        </label>

                                        <input type="hidden" name="degree_burn4" value="--">
                                        <input class="" type="checkbox" name="degree_burn4" id="degree_burn4"
                                            value="4th degree"
                                            {{ ($chdata->degree_burn4 == '4th degree'? ' checked' : '') }}>
                            ...
                            <div class="row">
                                <div class="col col-lg-5">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="concussionCh"
                                        id="concussionCh" value="Y"
                                        {{ ($chdata->concussionCh == 'Y'? ' checked' : '') }}>
                                            ...
                                            <div class="col px-md-5">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="openTypeCh"
                                                        id="openTypeCh" value="Y"
                                                        {{ ($chdata->openTypeCh == 'Y'? ' checked' : '') }}>
                                            ...
                                            <div class="col px-md-5">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="closedTypeCh"
                                                        id="closedTypeCh" value="Y"
                                                        {{ ($chdata->closedTypeCh == 'Y'? ' checked' : '') }}>
                ...
                <div class="innerdiv">
                    <div class="row">
                        <div class="col divpat1">
                            ...
                            <input class="form-check-input" type="checkbox" name="bitesCh" id="bitesCh" value="Y"
                                {{ ($chdata->bitesCh == 'Y'? ' checked' : '') }}>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="burn1Ch" id="burn1Ch"
                                        value="Y" {{ ($chdata->burn1Ch == 'Y'? ' checked' : '') }}>
                                    <label class="form-check-label" for="burn1Ch">
                                        Burn,
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="01" name="burnRdo" id="Heat"
                                        {{ ($chdata->burnRdo == '01'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Heat">
                                        Heat
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="02" name="burnRdo" id="Fire"
                                        {{ ($chdata->burnRdo == '02'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Fire">
                                        Fire
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="03" name="burnRdo"
                                        id="Electricty" {{ ($chdata->burnRdo == '03'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Electricty">
                                        Electricty
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="04" name="burnRdo" id="Oil"
                                        {{ ($chdata->burnRdo == '04'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Oil">
                                        Oil
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="05" name="burnRdo" id="Friction"
                                        {{ ($chdata->burnRdo == '05'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Friction">
                                        Friction
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="06" name="burnRdo" id="Others2"
                                        {{ ($chdata->burnRdo == '06'? ' checked' : '') }}>
                            ...
                            <div class="row">
                                <div class="col col-lg-8">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="chemicalCh" id="chemicalCh"
                                        value="Y" {{ ($chdata->chemicalCh == 'Y'? ' checked' : '') }}>
                                    <!-- <div class="row">
                                <div class="col-auto"> -->
                            ...
                            <div class="row">
                                <div class="col col-lg-8">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="sharpCh" id="sharpCh"
                                        value="Y" {{ ($chdata->sharpCh == 'Y'? ' checked' : '') }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="01" name="drowningRdo" id="Sea"
                                        {{ ($chdata->drowningRdo == '01'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Sea">
                                        Sea
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="02" name="drowningRdo"
                                        id="River" {{ ($chdata->drowningRdo == '02'? ' checked' : '') }}>
                                    <label class="form-check-label" for="River">
                                        River
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="03" name="drowningRdo" id="Lake"
                                        {{ ($chdata->drowningRdo == '03'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Lake">
                                        Lake
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="04" name="drowningRdo" id="Pool"
                                        {{ ($chdata->drowningRdo == '04'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Pool">
                                        Pool
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="05" name="drowningRdo"
                                        id="BathTub" {{ ($chdata->drowningRdo == '05'? ' checked' : '') }}>
                                    <label class="form-check-label" for="BathTub">
                                        Bath Tub
                                    </label>
                                </div>
                                <div class="col col-lg-4">
                                    <input class="form-check-input" type="radio" value="06" name="drowningRdo"
                                        id="Others3" {{ ($chdata->drowningRdo == '06'? ' checked' : '') }}>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="natureCh" id="natureCh"
                                        value="Y" {{ ($chdata->natureCh == 'Y'? ' checked' : '') }}>
                                    <label class="form-check-label" for="natureCh">
                                        Exposure to forces of Nature:
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="natureRdo" id="Earthquake"
                                        value="01" {{ ($chdata->natureRdo == '01'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Earthquake">
                                        Earthquake
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="natureRdo" id="Volcanic"
                                        value="02" {{ ($chdata->natureRdo == '02'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Volcanic">
                                        Volcanic eruption
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="natureRdo" id="Typhoon"
                                        value="03" {{ ($chdata->natureRdo == '03'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Typhoon">
                                        Typhoon
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="natureRdo" id="Landslide"
                                        value="04" {{ ($chdata->natureRdo == '04'? ' checked' : '') }}>
                                    <label class="form-check-label" for="Landslide">
                                        Landslide
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="natureRdo" id="natureOth"
                                        value="07" {{ ($chdata->natureRdo == '07'? ' checked' : '') }}>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="fallCh" id="fallCh" value="Y"
                                        {{ ($chdata->fallCh == 'Y'? ' checked' : '') }}>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="firecrackerCh"
                                        id="firecrackerCh" value="Y"
                                        {{ ($chdata->firecrackerCh == 'Y'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="firecracker_code"
                                                id="firecracker_code_1" value="03"
                                                {{ ($chdata->firecracker_code == '03'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="firecracker_code"
                                                id="firecracker_code_2" value="22"
                                                {{ ($chdata->firecracker_code == '22'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="firecracker_code"
                                                id="firecracker_code_3" value="01"
                                                {{ ($chdata->firecracker_code == '01'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="firecracker_code"
                                                id="firecracker_code_4" value="06"
                                                {{ ($chdata->firecracker_code == '06'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="firecracker_code"
                                                id="firecracker_code_5" value="23"
                                                {{ ($chdata->firecracker_code == '23'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="firecracker_code"
                                                id="firecracker_code_6" value="88"
                                                {{ ($chdata->firecracker_code == '88'? ' checked' : '') }}>
            ...
            <section>
                <div class="form-group rows-print-as-pages border border-secondary" style="page-break-after:always">
                    ...
                    <div class="col border-top border-secondary divpat1">
                        <div class="row border-bottom border-secondary">
                            ...
                            <div class="col-auto">
                                <input class="form-check-input" type="radio" name="areaRdo" id="Land" value="01"
                                    {{ ($chdata->areaRdo == '01'? ' checked' : '') }}>
                                <label class="form-check-label mx-auto" for="Land">
                                    Land
                                </label>
                            </div>
                            <div class="col-auto">
                                <input class="form-check-input" type="radio" name="areaRdo" id="Water" value="02"
                                    {{ ($chdata->areaRdo == '02'? ' checked' : '') }}>
                                <label class="form-check-label mx-auto" for="Water">
                                    Water
                                </label>
                            </div>
                            <div class="col col-lg-4">
                                <input class="form-check-input" type="radio" name="areaRdo" id="Air" value="03"
                                    {{ ($chdata->areaRdo == '03'? ' checked' : '') }}>
                                <label class="form-check-label mx-auto" for="Air">
                                    Air
                                </label>
                            </div>
                            <div class="col-auto">
                                <input class="form-check-input" type="radio" name="collRdo" id="Collision" value="10"
                                    {{ ($chdata->collRdo == '10'? ' checked' : '') }}>
                                <label class="form-check-label mx-auto" for="Collision">
                                    Collision
                                </label>
                            </div>
                            <div class="col-auto">
                                <input class="form-check-input" type="radio" name="collRdo" id="Non-Collision"
                                    value="20" {{ ($chdata->collRdo == '20'? ' checked' : '') }}>
                        ...
                        <div class="row border-bottom border-secondary">
                            ...
                            <div class="col-auto">
                                <input class="form-check-input" type="radio" name="severRdo" id="Fatal Accident"
                                    value="FatalAccident" {{ ($chdata->severRdo == 'FatalAccident'? ' checked' : '') }}>
                                <label class="form-check-label" for="Fatal Accident">
                                    Fatal Accident
                                </label>
                            </div>
                            <div class="col-auto">
                                <input class="form-check-input" type="radio" value="Serious" name="severRdo"
                                    id="Serious" value="Serious"
                                    {{ ($chdata->severRdo == 'Serious'? ' checked' : '') }}>
                            ...
                            <div class="col-auto">
                                <input class="form-check-input" type="radio" value="Minor" name="severRdo" id="Minor"
                                    value="Minor" {{ ($chdata->severRdo == 'Minor'? ' checked' : '') }}>
                            ...
                            <div class="col-auto">
                                <input class="form-check-input" type="radio" value="Property" name="severRdo"
                                    id="Property" value="Property"
                                    {{ ($chdata->severRdo == 'Property'? ' checked' : '') }}>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-auto float-left">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="vehicleRdo"
                                                    id="Pedestrian" value="00"
                                                    {{ ($chdata->vehicleRdo == '00'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="vehicleRdo" id="Car"
                                                    value="10" {{ ($chdata->vehicleRdo == '10'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="vehicleRdo" id="Van"
                                                    value="73" {{ ($chdata->vehicleRdo == '73'? ' checked' : '') }}>
                                        ...
                                        <div class="row row-lg-8">
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="vehicleRdo" id="Bus"
                                                    value="30" {{ ($chdata->vehicleRdo == '30'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="vehicleRdo"
                                                    id="Motorcycle" value="40"
                                                    {{ ($chdata->vehicleRdo == '40'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="vehicleRdo"
                                                    id="Tricycle" value="60"
                                                    {{ ($chdata->vehicleRdo == '60'? ' checked' : '') }}>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="otherRdo"
                                                    id="Pedestrian1" value="00"
                                                    {{ ($chdata->otherRdo == '00'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="otherRdo" id="Car1"
                                                    value="10" {{ ($chdata->otherRdo == '10'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="otherRdo" id="Van1"
                                                    value="73" {{ ($chdata->otherRdo == '73'? ' checked' : '') }}>
                                        ...
                                        <div class="row row-lg-8">
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="otherRdo" id="Bus1"
                                                    value="30" {{ ($chdata->otherRdo == '30'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="otherRdo"
                                                    id="Motorcycle1" value="40"
                                                    {{ ($chdata->otherRdo == '40'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="otherRdo"
                                                    id="Bicycle1" value="50"
                                                    {{ ($chdata->otherRdo == '50'? ' checked' : '') }}>
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="otherRdo"
                                                    id="Tricycle1" value="60"
                                                    {{ ($chdata->otherRdo == '60'? ' checked' : '') }}>
                                        ...
                                        <div class="row row-lg-8">
                                            ...
                                            <div class="col-auto">
                                                <input class="form-check-input" type="radio" name="otherRdo"
                                                    id="Unknown1" value="99"
                                                    {{ ($chdata->otherRdo == '99'? ' checked' : '') }}>
                            ...
                            <div class="col-auto border-end border-secondary">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="posRdo" id="Pedestrian2"
                                                value="10" {{ ($chdata->posRdo == '10'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="posRdo" id="Driver"
                                                value="20" {{ ($chdata->posRdo == '20'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="posRdo" id="Captain"
                                                value="50" {{ ($chdata->posRdo == '50'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="posRdo" id="Pilot"
                                                value="40" {{ ($chdata->posRdo == '40'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="posRdo" id="Front"
                                                value="30" {{ ($chdata->posRdo == '30'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="posRdo" id="Rear"
                                                value="35" {{ ($chdata->posRdo == '35'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="posRdo" id="Others8"
                                                value="88" {{ ($chdata->posRdo == '88'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="posRdo" id="Unknown2"
                                                value="99" {{ ($chdata->posRdo == '99'? ' checked' : '') }}>
                            ...
                            <div class="col border-bottom border-secondary" id="colViIn">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="victimsRdo" id="Alone"
                                                value="alone" {{ ($chdata->victimsRdo == 'alone'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="victimsRdo"
                                                id="Withothers" value="Withothers"
                                                {{ ($chdata->victimsRdo == 'Withothers'? ' checked' : '') }}>
                        ...
                        <div class="row">
                            <div class="col-auto border border-secondary border-left-0 border-right-0">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="placeRdo" id="Home"
                                                value="10" {{ ($chdata->placeRdo == '10'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="placeRdo" id="School"
                                                value="30" {{ ($chdata->placeRdo == '30'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="placeRdo" id="Road"
                                                value="50" {{ ($chdata->placeRdo == '50'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="placeRdo" id="Bars"
                                                value="60" {{ ($chdata->placeRdo == '60'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="placeRdo" id="Workplace"
                                                value="70" {{ ($chdata->placeRdo == '70'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="placeRdo" id="Others9"
                                                value="88" {{ ($chdata->placeRdo == '88'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" checked name="placeRdo"
                                                id="Unkown4" value="99"
                                                {{ ($chdata->placeRdo == '99'? ' checked' : '') }}>
                            ...
                            <div class="col-auto border border-secondary">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="activityRdo" id="Sports"
                                                value="10" {{ ($chdata->activityRdo == '10'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="activityRdo" id="Leisure"
                                                value="20" {{ ($chdata->activityRdo == '20'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="activityRdo"
                                                id="Workrelated" value="30"
                                                {{ ($chdata->activityRdo == '30'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" name="activityRdo"
                                                id="Others10" value="88"
                                                {{ ($chdata->activityRdo == '88'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" checked name="activityRdo"
                                                id="Unkown5" value="99"
                                                {{ ($chdata->activityRdo == '99'? ' checked' : '') }}>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="col-auto">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="alcoholCh"
                                                id="Alchohol" value="Y"
                                                {{ ($chdata->alcoholCh == 'Y'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="smokingCh"
                                                id="Smoking" value="Y"
                                                {{ ($chdata->smokingCh == 'Y'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="drugsCh" id="Drugs"
                                                value="Y" {{ ($chdata->drugsCh == 'Y'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="phoneCh" id="phone"
                                                value="Y" {{ ($chdata->phoneCh == 'Y'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="sleepyCh" id="Sleepy"
                                                value="Y" {{ ($chdata->sleepyCh == 'Y'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="others11Ch"
                                                id="Others11" value="Y"
                                                {{ ($chdata->others11Ch == 'Y'? ' checked' : '') }}>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="risk_noneCh"
                                                id="risk_none" value="none"
                                                {{ ($chdata->risk_noneCh == 'none'? ' checked' : '') }}>
                        ...
                        <div class="row border-bottom border-secondary">
                            ...
                            <div class="col-auto">
                                ...
                                <input class="form-check-input" type="checkbox" name="noneCh" id="noneCh" value="Y"
                                    {{ ($chdata->noneCh == 'Y'? ' checked' : '') }}>
                            ...
                            <div class="col-auto">
                                ...
                                <input class="form-check-input" type="checkbox" name="airbagCh" id="airbagCh" value="Y"
                                    {{ ($chdata->airbagCh == 'Y'? ' checked' : '') }}>
                            ...
                            <div class="col-auto">
                                ...
                                <input class="form-check-input" type="checkbox" name="helmetCh" id="helmetCh" value="Y"
                                    {{ ($chdata->helmetCh == 'Y'? ' checked' : '') }}>
                            ...
                            <div class="col-auto">
                                ...
                                <input class="form-check-input" type="checkbox" name="childseatCh" id="childseatCh"
                                    value="Y" {{ ($chdata->childseatCh == 'Y'? ' checked' : '') }}>
                            ...
                            <div class="col-auto">
                                ...
                                <input class="form-check-input" type="checkbox" name="seatbeltCh" id="seatbeltCh"
                                    value="Y" {{ ($chdata->seatbeltCh == 'Y'? ' checked' : '') }}>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="unknown5Ch"
                                            id="unknown5Ch" value="Y"
                                            {{ ($chdata->unknown5Ch == 'Y'? ' checked' : '') }}>
                            ...
                            <div class="col-auto">
                                ...
                                <input class="form-check-input" type="checkbox" name="vestCh" id="vestCh" value="Y"
                                    {{ ($chdata->vestCh == 'Y'? ' checked' : '') }}>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="others12Ch"
                    ...
                    <div class="form-group border border-secondary divpat1">
                        <div class="p-2 bg-success text-white">
                            ...
                            <div class="row">
                                <div class="col">A.
                                    <select id="patType" name="patType" class="form-select-sm"
                                        aria-label=".form-select-sm example">
                        ...
                        <div class="row-auto">
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <select id="ref_hosp_code" name="ref_hosp_code" class="form-select-sm"
                                        aria-label=".form-select-sm example">
                        ...
                        <div class="row-auto border border-secondary border-left-0 border-right-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" required value="01" name="transpoRdo"
                                        id="ambulance" {{ ($chdata->transpoRdo == '01'? ' checked' : '') }}>
                                    <label class="form-check-label" for="ambulance">
                                        Ambulance
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="02" name="transpoRdo"
                                        id="police" {{ ($chdata->transpoRdo == '02'? ' checked' : '') }}>
                                    <label class="form-check-label" for="police">
                                        Police vehicle
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="03" name="transpoRdo"
                                        id="private" {{ ($chdata->transpoRdo == '03'? ' checked' : '') }}>
                                    <label class="form-check-label" for="private">
                                        Private vehicle
                                    </label>
                                </div>
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" value="04" name="transpoRdo"
                                        id="others13" {{ ($chdata->transpoRdo == '04'? ' checked' : '') }}>
                            ...
                            <div class="col">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-auto px-md-5">
                                                    <input class="form-check-input" required type="radio" value="ADMIT"
                                                        name="dispoRdo" id="admitted"
                                                ...
                                                <div class="col-auto px-md-5">
                                                    <input class="form-check-input" type="radio" value="TRASH"
                                                        name="dispoRdo" id="senthome"
                                                ...
                                                <div class="col-auto">
                                                    <input class="form-check-input" type="radio" value="REFER"
                                                        name="dispoRdo" id="transfer"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-auto px-md-5">
                                                    <input class="form-check-input" type="radio" value="HAMAA"
                                                        name="dispoRdo" id="HAMA"
                                                ...
                                                <div class="col-auto px-md-5">
                                                    <input class="form-check-input" type="radio" value="ABSCN"
                                                        name="dispoRdo" id="absconded"
                                                        {{ ($chdata->dispoRdo == 'ABSCN'? ' checked' : '') }}>
                                ...
                                <div class="col border-top border-secondary">
                                    <div class="row ">
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" required type="radio" value="10"
                                                name="outcome" id="improved"
                                        ...
                                        <div class="col-auto">
                                            <input class="form-check-input" type="radio" value="30" name="outcome"
                                                id="died" {{ ($chdata->outcome == '30'? ' checked' : '') }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inPatDispoRdo" id="inDischarged"
                                        value="DISCH" {{ ($chdata->inPatDispoRdo == 'DISCH'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inPatDispoRdo" id="inHama"
                                        value="HAMA" {{ ($chdata->inPatDispoRdo == 'HAMA'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inPatDispoRdo" id="inAbson"
                                        value="ABSCN" {{ ($chdata->inPatDispoRdo == 'ABSCN'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    <input class="form-check-input" type="radio" name="inPatDispoRdo" id="inOthers"
                                        value="oth" {{ ($chdata->inPatDispoRdo == 'oth'? ' checked' : '') }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <input class="form-check-input" type="radio" name="inPatDispoRdo" id="inTransfer"
                                        value="admTransferred"
                                        {{ ($chdata->inPatDispoRdo == 'admTransferred'? ' checked' : '') }}>

                                    <label class="form-check-label" for="inTransfer">
                                        Transferred to another facility/hopital, specify:
                                    </label>
                                    <select id="disp_inpat_oth" name="disp_inpat_oth" class="form-select-sm"
                                        aria-label=".form-select-sm example">
                                        <option value="{{$patients->disp_inpat_oth}}">{{$patients->disp_inpat_oth}}
                                        </option>
                                        <option value="Notre Dame de Chartes Hospital">Notre Dame de Chartes Hospital
                                        </option>
                                        <option value="Saint Louis University Hospital of the Sacred Heart">Saint Louis
                                            University Hospital of the Sacred Heart</option>
                                        <option value="Baguio Medical Center">Baguio Medical Center</option>
                                        <option value="Pines City Doctor's Hospital">Pines City Doctor's Hospital
                                        </option>
                                        <option value="Fort Del Pilar Station Hospital">Fort Del Pilar Station Hospital
                                        </option>
                                        <option value="Camp 8 Health Center">Camp 8 Health Center</option>
                                    </select>
                        ...
                        <div class="col border-top border-secondary">
                            <div class="row ">
                                ...
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="radio" name="inPatOutcomeRdo" id="inImprov"
                                        value="10" {{ ($chdata->inPatOutcomeRdo == '10'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="radio" name="inPatOutcomeRdo" id="inUnimprov"
                                        value="20" {{ ($chdata->inPatOutcomeRdo == '20'? ' checked' : '') }}>
                                ...
                                <div class="col-auto">
                                    ...
                                    <input class="form-check-input" type="radio" name="inPatOutcomeRdo" id="inDied"
                                        value="30" {{ ($chdata->inPatOutcomeRdo == '30'? ' checked' : '') }}>
                                ...
                                <div class="col-auto border-top border-bottom border-secondary">
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="row">
                                                <div class="col-auto">
                                                    <h6 class="form-check-label" for="flexCheckDefault">Completed By:
                                                    </h6>
                                                </div>
                                                <div class="col-auto">
                                                    <input type="hidden" name="chsame" value="0">
                                                    <input type="checkbox" value="1" name="chsame" id="chsame"
                                                        {{ ($chdata->chsame == '1'? ' checked' : '') }}>
        ...
        <div class="row">
            ...
            <div class="col d-flex justify-content-end">
                ...
                <button id="saveinto" type="submit" class="btn btn-primary d-print-none"
                    onclick="return confirm(&quot;WARNING! saving into 'Final Output' will delete the current patient in DRAFTS, Continue?&quot;)"><i
                        class="fa fa-search"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <select id="status" name="status" class="form-select-sm d-print-none"
                    aria-label=".form-select-sm example">
            ...
            <div class="col-auto d-flex justify-content-end">
                <button title="Print" class="btn btn-warning d-print-none" onclick="document.execCommand('print')"><i
