            ...
            <tbody>
                ...
                <tr>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="/patientShow/">Edit</a></li>
                        <li><a class="dropdown-item" href="/export/" ><input type="hidden" name="sendToExport" id="sendToExport" value="completeForm"> Export</a></li>
                    </ul>
                    </div> -->
                    <div class="dropdown">
                    <a class="btn btn-warning btn-sm" href="/cancerForm/{{$item->hpercode}}">
                        Edit
                    </a>
                    <!-- <input type="checkbox" name="sendToExport" value="completeForm"> -->
                    </div>
                    
                      <!-- <a class="btn btn-success btn-sm " href="/patientShow/">Edit</a>
                      <a class="btn btn-danger btn-sm " href="/patientShow/">To export lists</a> -->
                    </td>
                </tr>
                @endforeach
                </tbody>
